...
export default async function AdminEventsPage() {
  ...
  return (
    <>
      <AdminPageHeader
        title="Events"
        description="Feature events on the homepage carousel. Only approved organizers' events are visible publicly."
      />
                ...
                <tr key={event.slug} className="bg-surface/20">
                  <td className="px-4 py-4">
                    ...
                    {event.isPubliclyVisible ? (
                      ...
                      <p className="text-xs text-amber-200/80">Hidden from public</p>
                    )}
                  </td>
                  <td className="px-4 py-4">
