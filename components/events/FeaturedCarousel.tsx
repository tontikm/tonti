  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8">
        <div className="relative aspect-[16/10] max-h-[min(72vh,680px)] min-h-[320px] w-full overflow-hidden rounded-[28px] bg-black sm:aspect-[16/9] sm:rounded-[32px]">
            ...
            return (
              ...
              >
                <Image
                  ...
                  fill
                  priority={index === 0}
                  className="carousel-photo object-cover object-center scale-[1.03]"
                  sizes="(max-width: 1440px) 100vw, 1440px"
                />

                <div className="carousel-grade pointer-events-none absolute inset-0" />
